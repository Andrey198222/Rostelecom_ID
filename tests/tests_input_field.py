...
@pytest.mark.parametrize("negative_input", [russian_chars(1), russian_chars(31), russian_chars(256), english_chars(15), number_chars(18),  special_chars(19)], ids=['1 символ кир.', '31 символ кир.', '256 символов кир.', '15 символов лат.', '18 цифр', '10 иероглифов', '19 спецсимволов'])
...
@pytest.mark.parametrize("negative_input", ['+7 952 697-45-123', '+7 956 789-64-97', '+375 45 478-78-9', '+375 96 858-56-333', '+375 17 iu-37-41', '+7 962 381-之大-91'], ids=['12 цыфр', '10 цыфр', '11 цыфр', '13 цыфр', 'цыфры+буквы', 'цыфры+иероглифы'])
